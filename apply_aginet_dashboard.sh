...
ROOT="${1:-$(pwd)}"
BACKUP_DIR="$ROOT/.paste-backups/aginet-dashboard-$(date +%Y%m%d-%H%M%S)"
...
echo "[patch] adding aginet dashboard command"
...
echo '  git commit -m "add aginet dashboard command"'
