...
ROOT="${1:-$(pwd)}"
BACKUP_DIR="$ROOT/.paste-backups/aginet-modes-$(date +%Y%m%d-%H%M%S)"
...
echo "[patch] adding quick/full modes to aginet dashboard"
...
echo '  git commit -m "add quick and full modes to aginet dashboard"'
